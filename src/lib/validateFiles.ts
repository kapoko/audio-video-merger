...
export function createRequestFromFileList(files: FileList): ProcessFilesRequest {
...
export function createRequestFromFileInfo(files: FileInfo[]): ProcessFilesRequest {
